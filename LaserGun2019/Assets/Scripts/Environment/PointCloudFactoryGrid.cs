...
[Serializable]
public class PointCloudFactoryGrid : IPointCloudFactory
{  
    [SerializeField] private int columnAmount;
    [SerializeField] private int columnInterval;
    ...
    [SerializeField]
    private PointCloudDirection pointCloudDirection =
        PointCloudDirection.plusX;
    ...
    public List<Vector3> GetPointCloud(Vector3 position)
    {
